"""
Django settings for connector_ravinder__77273 project.
...
ROOT_URLCONF = 'connector_ravinder__77273.urls'
...
WSGI_APPLICATION = 'connector_ravinder__77273.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "connector_ravinder__77273 API",
    "DESCRIPTION": "API documentation for connector_ravinder__77273 App",
    "VERSION": "v1",
}
