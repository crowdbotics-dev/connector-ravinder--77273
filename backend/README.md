...
## Project Structure
    ...
    ├── connector_ravinder__77273  # Django project configurations
...
1. Clone this repo and `cd connector_ravinder__77273`
...
2. Clone this repo and `cd connector_ravinder__77273`
